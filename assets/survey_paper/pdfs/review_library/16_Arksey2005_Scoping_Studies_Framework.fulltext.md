...
Source PDF: /Users/mac/Documents/6-Research/1-SpatialAgent/assets/survey_paper/pdfs/review_library/16_Arksey2005_Scoping_Studies_Framework.pdf

Extraction:
- backend: pdfplumber
- extracted_at_utc: 2026-05-01T02:59:22+00:00
- page_count: 31
- status: ok
- text_char_count: 43165

Metadata:
- author: Arksey, H and O'Malley, L
- doi: unknown
...
- subject: different types o fscoping studies and their relation to full systematic reviews. Frameworks for conducting a scoping study.

Outline:
- Article accepted by: International Journal of Social Researc (page 2)
- This is an electronic version of an article published in Ark (page 2)
- SCOPING STUDIES: TOWARDS A METHODOLOGICAL FRAMEWORK (page 2)
- Bionotes (page 4)
- What is a scoping study? (page 8)
- Methodological framework (page 11)
- Framework Stage 1: Identifying the research question (page 12)
- Framework Stage 2: Identifying relevant studies (page 13)
- As already indicated, the whole point of scoping the field i (page 13)
- electronic databases (page 13)
- existing networks, relevant organisations and conferences. (page 13)
- Electronic databases, the Internet and Research Registers (page 14)
- The search strategy for electronic databases is developed fr (page 14)
- Reference lists (page 15)
- Hand-searching of key journals (page 15)
- Existing networks, relevant organisations and conferences (page 16)
- Framework Stage 3: Study selection (page 17)
- Framework Stage 4: Charting the data (page 18)
- Framework Stage 5: Collating, summarising and reporting the (page 20)
  - Resource implications (page 24)
- Discussion and conclusion (page 25)
- The proposed framework includes a role for key stakeholder g (page 25)
