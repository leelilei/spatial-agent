...
- corpus_tier: `Core`
- system_family: `Fire Evacuation CA`
- paper_refs: `FireEvacuation2025`
- year: `2025`
- agent_count: `2-10`
...
The backend scenario is reconstructed from LiDAR and 3D scanning, but the LLM-facing interface is a directional textual rendering of a cell-semantic 2D automaton with height, visibility, and short-term memory context rather than direct geometry.

## Original Artifact Pointer

- local_artifact_path: `assets/survey_paper/pdfs/phase1_core/14_HC13_Fire_Evacuation_CA.pdf`
