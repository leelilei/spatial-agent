...
- Telephone index: 46
- Preferred source: Transactions on Machine Learning Research
- DOI: none
- arXiv: 2305.16291
...
Source PDF: D:\0-Research\5-Telephone\assets\papers\pdf\04_memory_state_agents\46_voyager.pdf

Extraction:
- backend: pdfplumber
- extracted_at_utc: 2026-06-20T12:43:56+00:00
- page_count: 42
- status: ok
- text_char_count: 120215
...
- Introduction (page 2)
- Method (page 3)
  - Automatic Curriculum (page 3)
  - Skill Library (page 4)
  - Iterative Prompting Mechanism (page 5)
- Experiments (page 6)
  - Experimental Setup (page 6)
  - Baselines (page 6)
  - Evaluation Results (page 7)
  - Ablation Studies (page 8)
  - Multimodal Feedback from Humans (page 9)
- Limitations and Future Work (page 10)
- Related work (page 10)
- Conclusion (page 11)
- Broader Impacts (page 11)
- Acknowledgements (page 11)
- Method (page 19)
  - Voyager Algorithm (page 19)
  - Prompting (page 19)
  - Automatic Curriculum (page 20)
    - Components in the Prompt (page 20)
    - Additional Context (page 20)
    - Warm-up Schedule (page 20)
    - Full Prompt (page 21)
  - Skill Library (page 24)
    - Components in the Prompt (page 24)
    - Full Prompt (page 26)
    - Examples (page 32)
  - Self-Verification (page 35)
    - Components in the Prompt (page 35)
    - Full Prompt (page 35)
  - System-level Comparison between Voyager and Prior Works (page 37)
- Experiments (page 38)
  - Experimental Setup (page 38)
  - Baselines (page 38)
  - Ablations (page 39)
  - Evaluation Results (page 39)
    - Significantly Better Exploration (page 39)
    - Extensive Map Traversal (page 41)
    - Efficient Zero-Shot Generalization to Unseen Tasks (page 41)
    - Accurate Skill Retrieval (page 42)
    - Robust to Model Variations (page 42)
...
De˛biak, Christy Dennison, David Farhi, Quirin Fischer, Shariq Hashme, Chris Hesse, Rafal Józefowicz, Scott Gray, Catherine Olsson, Jakub Pachocki, Michael Petrov, Henrique P. d. O. Pinto,
...
[80] Valts Blukis, Chris Paxton, Dieter Fox, A
semantic representation for high-level nat
Conference on Robot Learning, 2021.
[81] Varun Nair, Elliot Schumacher, Geoffrey
language model completions with dialog
Arxiv-2303.17071, 2023.
[82] Joon Sung Park, Joseph C. O’Brien, Carri
Michael S. Bernstein. Generative agents
preprint arXiv: Arxiv-2304.03442, 2023.
[83] Yue Wu, Shrimai Prabhumoye, So Yeon
Azaria, Tom Mitchell, and Yuanzhi Li. Sp
papers and reasoning. arXiv preprint arXi
[84] Erik Nijkamp, Bo Pang, Hiroaki Hayashi,
and Caiming Xiong. A conversational par
Arxiv-2203.13474, 2022.
[85] Hung Le, Yue Wang, Akhilesh Deepak Got
Mastering code generation through pretrai
preprint arXiv: Arxiv-2207.01780, 2022.
[86] Xinyun Chen, Chang Liu, and Dawn Song
International Conference on Learning Re
May 6-9, 2019. OpenReview.net, 2019.
[87] Xinyun Chen, Dawn Song, and Yuandong
arXiv preprint arXiv: Arxiv-2107.00101, 2
[88] Kevin Ellis, Maxwell I. Nye, Yewen Pu,
Lezama. Write, execute, assess: Program s
Larochelle, Alina Beygelzimer, Florence
editors, Advances in Neural Information Pr
Information Processing Systems 2019, Ne
Canada, pages 9165–9174, 2019.
[89] Yujia Li, David Choi, Junyoung Chung, N
Tom Eccles, James Keeling, Felix Gimen
Cyprien de Masson d’Autume, Igor Babusc
Sven Gowal, Alexey Cherepanov, James Mo
Pushmeet Kohli, Nando de Freitas, Koray
code generation with alphacode. arXiv pre
[90] Karl Cobbe, Vineet Kosaraju, Mohammad
Matthias Plappert, Jerry Tworek, Jacob H
John Schulman. Training verifiers to solve
2110.14168, 2021.
[91] Ansong Ni, Srini Iyer, Dragomir Radev
Xi Victoria Lin. Lever: Learning to verify
preprint arXiv: Arxiv-2302.08468, 2023.
[92] Marta Skreta, Naruki Yoshikawa, Sebastia
Kourosh Darvish, Alán Aspuru-Guzik, Flo
prompts: Instruction guided task programm
preprint arXiv: Arxiv-2303.14100, 2023.

esh Garg, and Yoav Artzi. A persistent spatial
language instruction execution. In 5th Annual
o, and Anitha Kannan. Dera: Enhancing large
abled resolving agents. arXiv preprint arXiv:
Cai, Meredith Ringel Morris, Percy Liang, and
teractive simulacra of human behavior. arXiv
n, Yonatan Bisk, Ruslan Salakhutdinov, Amos
g: Gpt-4 out-performs rl algorithms by studying
305.15486, 2023.
Tu, Huan Wang, Yingbo Zhou, Silvio Savarese,
gm for program synthesis. arXiv preprint arXiv:
e, Silvio Savarese, and Steven C. H. Hoi. Coderl:
models and deep reinforcement learning. arXiv
ecution-guided neural program synthesis. In 7th
sentations, ICLR 2019, New Orleans, LA, USA,
n. Latent execution for neural program synthesis.
.
x Sosa, Josh Tenenbaum, and Armando Solarhesis with a REPL. In Hanna M. Wallach, Hugo
Alché-Buc, Emily B. Fox, and Roman Garnett,
ssing Systems 32: Annual Conference on Neural
PS 2019, December 8-14, 2019, Vancouver, BC,
Kushman, Julian Schrittwieser, Rémi Leblond,
Agustin Dal Lago, Thomas Hubert, Peter Choy,
n, Xinyun Chen, Po-Sen Huang, Johannes Welbl,
y, Daniel J. Mankowitz, Esme Sutherland Robson,
ukcuoglu, and Oriol Vinyals. Competition-level
nt arXiv: Arxiv-2203.07814, 2022.
varian, Mark Chen, Heewoo Jun, Lukasz Kaiser,
on, Reiichiro Nakano, Christopher Hesse, and
ath word problems. arXiv preprint arXiv: Arxivs Stoyanov, Wen tau Yih, Sida I. Wang, and
guage-to-code generation with execution. arXiv
rellano-Rubach, Zhi Ji, Lasse Bjørn Kristensen,
n Shkurti, and Animesh Garg. Errors are useful
with verifier-assisted iterative prompting. arXiv
...
begins with basic skills and progressively adva
warm-up setting that we use across all the exper
Table A.1: Warm-up sched
Information in the prompt
core inventory (only including log, planks, st
crafting table, furnace, dirt, coal, pickaxe, sw
and axe)
equipment
nearby blocks
position
...
additional context
A.3.4 Full Prompt
Prompt 1: Full system prompt for automatic curr
the additional context.
You are a helpful assistant that t
do in Minecraft . My ultimate g
things as possible , accomplish
and become the best Minecraft
I will give you the following info
Question 1: ...
Answer : ...
Question 2: ...
Answer : ...
...
Time : ...
Nearby blocks : ...
Other blocks that are recently see
Nearby entities ( nearest to farthe
Health : Higher than 15 means I ’m h
Hunger : Higher than 15 means I ’m n
Position : ...
Equipment : If I have better armor
to equip it .
Inventory ( xx /36) : ...
Chests : You can ask me to deposit
There also might be some unkno
and check items inside the unk
Completed tasks so far : ...
Failed tasks that are too hard : ..
You must follow the following crit
1) You should act as a mentor and
my current learning progress .
2) Please be very specific about w
what I need to craft , or what

s towards more intricate and diverse ones. The
nts is shown in Table. A.1.
for automatic curriculum.
...
15
15
um. The list of question-answer pairs represents
ls me the next immediate task to
is to discover as many diverse
many diverse tasks as possible
yer in the world .
ation :
...
): ...
lthy .
hungry .
my inventory , you should ask me
take items from these chests .
chest , you should ask me to open
n chest .
ia :
ide me to the next task based on
t resources I need to collect ,
s I need to kill .
