...
- Telephone index: 1
- Preferred source: Proceedings of the 36th Annual ACM Symposium on User Interface Software and Technology (UIST 2023)
- DOI: 10.1145/3586183.3606763
- arXiv: 2304.03442
- PDF: `assets\papers\pdf\01_agent_societies\01_generative-agents.pdf`

## Extracted Abstract

Believable proxies of human behavior can empower interactive applications ranging from immersive environments to rehearsal spaces for interpersonal communication to prototyping tools. In this paper, we introduce generative agents: computational software agents that simulate believable human behavior. Generative agents wake up, cook breakfast, and head to work; artists paint, while authors write; they form opinions, notice each other, and initiate conversations; they remember and reflect on days past as they plan the next day. To enable generative agents, we describe an architecture that extends a large language model to store a complete record of the agent’s experiences using natural language, synthesize those memories over time into higher-level reflections, and retrieve them dynamically to plan behavior. We instantiate generative agents to populate an interactive sandbox environment inspired by The Sims, where end users can interact with a small town of twenty-five agents using natural language. In an evaluation, these generative agents produce believable individual and emergent social behaviors. For example, starting with only a single user-specified notion that one agent wants to throw a Valentine’s Day party, the agents autonomously spread invitations to the party over the next two UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA days, make new acquaintances, ask each other out on dates to the party, and coordinate to show up for the party together at the right time. We demonstrate through ablation that the components of our agent architecture—observation, planning, and reflection—each contribute critically to the believability of agent behavior. By fusing large language models with computational interactive agents, this work introduces architectural and interaction patterns for enabling believable simulations of human behavior.
Title: Abstract

Source PDF: D:\0-Research\5-Telephone\assets\papers\pdf\01_agent_societies\01_generative-agents.pdf

Extraction:
- backend: pdfplumber
- extracted_at_utc: 2026-06-20T12:38:38+00:00
- page_count: 22
- status: ok
- text_char_count: 129267
...
Generative Agents
Figure 2: The Smallville sandbox world, with areas labeled. T
(e.g., houses, cafe, stores), and leaf nodes describe objects (e.g.
parts of the world they have seen, maintaining the state of th
...
UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA
root node describes the entire world, children describe areas
ble, bookshelf). Agents remember a subgraph that reflects the
parts as they observed them.
...
Generative Agents
Figure 3: A morning in the life of a generative agent, John Lin
which includes brushing his teeth, taking a shower, and eat
...
UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA
hn wakes up around 6 am and completes his morning routine,
breakfast. He briefly catches up with his wife, Mei, and son,
...
UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA
Figure 5: Our generative agent architecture. Agents perceive th
record of the agent’s experiences called the memory stream
memories and uses those retrieved actions to determine an ac
plans and create higher-level reflections, both of which are e
...
J.S. Park, J.C. O’Brien, C.J. Cai, M.R. Morris, P. Liang, M.S. Bernstein
environment, and all perceptions are saved in a comprehensive
sed on their perceptions, the architecture retrieves relevant
. These retrieved memories are also used to form longer-term
red into the memory stream for future use.
...
Generative Agents
Figure 6: The memory stream comprises a large number of ob
situation. Retrieval identifies a subset of these observation
...
UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA
vations that are relevant and irrelevant to the agent’s current
at should be passed to the language model to condition its
...
combination of the three elements: 𝑠𝑐𝑜𝑟𝑒 = 𝛼 𝑟𝑒𝑐𝑒𝑛𝑐𝑦 · 𝑟𝑒𝑐𝑒𝑛𝑐𝑦 +
𝛼 𝑖𝑚𝑝𝑜𝑟𝑡𝑎𝑛𝑐𝑒 · 𝑖𝑚𝑝𝑜𝑟𝑡𝑎𝑛𝑐𝑒 + 𝛼 𝑟𝑒𝑙𝑒𝑣𝑎𝑛𝑐𝑒 · 𝑟𝑒𝑙𝑒𝑣𝑎𝑛𝑐𝑒. In our implementation, all 𝛼s are set to 1. The top-ranked memories that fit within
...
UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA
Figure 7: A reflection tree for Klaus Mueller. The agent’s obser
synthesized to derive Klaus’s self-notion that he is highly de
...
J.S. Park, J.C. O’Brien, C.J. Cai, M.R. Morris, P. Liang, M.S. Bernstein
ons of the world, represented in the leaf nodes, are recursively
ted to his research.
...
UIST ’23, October 29-November 1, 2023, San Francisco, CA, USA
Figure 9: The diffusion path for Isabella Rodriguez’s Valentin
Isabella, who heard about the party at Hobbs Cafe by the end
...
J.S. Park, J.C. O’Brien, C.J. Cai, M.R. Morris, P. Liang, M.S. Bernstein
Day party invitation involved a total of 12 agents, aside from
the simulation.
...
California, USA). ACM.
[36] Tom Francis. 2010. The Minecraft Experiment, day 1: Chasing Waterfalls. http://www.pcgamer.com/2010/11/20/the-minecraft-experiment-day-
...
1) self-knowledge, 2) memory, 3) planning, 4) reactions, and 5) reflections. Below, we have listed the interview questions utilized in
