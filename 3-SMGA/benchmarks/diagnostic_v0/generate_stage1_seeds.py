...
SEED_SPECS = [
    {
        # Migrated from the original hand-authored seed_0001 (cast + topics kept).
        "seed_id": "seed_0001",
        ...
        "reputation": "Omar",
        "routine_person": "Nia",
        "work_topic": "paper deadline",
        "topic_slug": "paper_deadline",
        "deliverable": "analysis section",
        "integration_task": "final integration pass",
        "sensitive_topic": "ethics concern",
        "sensitive_item": "ethics-concern detail",
        "sensitive_marker": "ethics concern",
        "routine_activity": "late studio work",
        "routine_place": "studio",
        "routine_marker": "studio work",
        "external_party": "external reviewer",
        "distractor_topic": "prototype demo",
    },
    {
        # Migrated from the original hand-authored seed_0002 (cast + topics kept).
        "seed_id": "seed_0002",
        "scenario_id": "scenario_0002",
        "lead": "Ana",
        "partner": "Ben",
        "source": "Cara",
        "core": "Dan",
        "reputation": "Eve",
        "routine_person": "Finn",
        "work_topic": "grant resubmission",
        "topic_slug": "grant_resubmission",
        "deliverable": "budget table",
        "integration_task": "resubmission pass",
        "sensitive_topic": "budget cut",
        "sensitive_item": "budget-cut detail",
        "sensitive_marker": "budget cut",
        "routine_activity": "morning standup",
        "routine_place": "meeting room",
        "routine_marker": "morning standup",
        "external_party": "external partner",
        "distractor_topic": "demo slot",
    },
    {
        "seed_id": "seed_0003",
...
# --- Stage 2 scale-out: name + theme pools for programmatic seed specs -------
# seed_0001..0010 stay hand-specified above; seed_0011+ are generated by pairing
# a 6-person cast (rotated from NAME_POOL) with a scenario THEME. Themes are
# surface dressing on the same diagnostic structure, so theme reuse across seeds
# with distinct casts is acceptable diagnostic variety. routine_place must never
# be "lab" (the routine relocates TO the lab in event_0013).
NAME_POOL = [
    "Aaron", "Bela", "Cleo", "Dario", "Esme", "Farouk", "Gita", "Hana",
    "Idris", "Juno", "Kamal", "Lottie", "Milo", "Nadia", "Oskar", "Petra",
    "Quincy", "Rosa", "Sami", "Talia", "Ugo", "Vera", "Wren", "Yara",
    "Zane", "Anya", "Boaz", "Celia", "Dov", "Elif", "Fritz", "Greta",
    "Hiro", "Ines", "Jonas", "Kira", "Liam", "Mira", "Nils", "Orla",
    "Pia", "Reuben", "Sade", "Tomas", "Ute", "Viktor", "Wanda", "Ximena",
    "Yusuf", "Zara", "Arlo", "Bess", "Caleb", "Dara",
]

THEME_POOL = [
    {"work_topic": "journal revision", "topic_slug": "journal_revision", "deliverable": "results section", "integration_task": "revision merge", "sensitive_topic": "reviewer identity", "sensitive_item": "reviewer-identity detail", "sensitive_marker": "reviewer identity", "routine_activity": "lab cleanup", "routine_place": "storage room", "routine_marker": "lab cleanup", "external_party": "outside collaborator", "distractor_topic": "figure order"},
    {"work_topic": "thesis chapter", "topic_slug": "thesis_chapter", "deliverable": "methods chapter", "integration_task": "chapter integration", "sensitive_topic": "committee dispute", "sensitive_item": "committee-dispute detail", "sensitive_marker": "committee dispute", "routine_activity": "reading group", "routine_place": "seminar room", "routine_marker": "reading group", "external_party": "external examiner", "distractor_topic": "slide theme"},
    {"work_topic": "patent filing", "topic_slug": "patent_filing", "deliverable": "claims draft", "integration_task": "filing assembly", "sensitive_topic": "prior-art gap", "sensitive_item": "prior-art-gap detail", "sensitive_marker": "prior-art gap", "routine_activity": "prototype test", "routine_place": "test bay", "routine_marker": "prototype test", "external_party": "outside counsel", "distractor_topic": "logo choice"},
    {"work_topic": "product launch", "topic_slug": "product_launch", "deliverable": "spec sheet", "integration_task": "launch assembly", "sensitive_topic": "pricing change", "sensitive_item": "pricing-change detail", "sensitive_marker": "pricing change", "routine_activity": "planning sync", "routine_place": "planning room", "routine_marker": "planning sync", "external_party": "press contact", "distractor_topic": "banner art"},
    {"work_topic": "compliance audit", "topic_slug": "compliance_audit", "deliverable": "findings memo", "integration_task": "response assembly", "sensitive_topic": "staffing cut", "sensitive_item": "staffing-cut detail", "sensitive_marker": "staffing cut", "routine_activity": "compliance check", "routine_place": "compliance room", "routine_marker": "compliance check", "external_party": "external auditor", "distractor_topic": "font choice"},
    {"work_topic": "trial protocol", "topic_slug": "trial_protocol", "deliverable": "dosing table", "integration_task": "protocol merge", "sensitive_topic": "adverse event", "sensitive_item": "adverse-event detail", "sensitive_marker": "adverse event", "routine_activity": "safety review", "routine_place": "safety room", "routine_marker": "safety review", "external_party": "outside monitor", "distractor_topic": "site logo"},
    {"work_topic": "grant renewal", "topic_slug": "grant_renewal", "deliverable": "aims page", "integration_task": "renewal assembly", "sensitive_topic": "overhead rate", "sensitive_item": "overhead-rate detail", "sensitive_marker": "overhead rate", "routine_activity": "budget sync", "routine_place": "finance room", "routine_marker": "budget sync", "external_party": "program officer", "distractor_topic": "cover color"},
    {"work_topic": "conference talk", "topic_slug": "conference_talk", "deliverable": "demo script", "integration_task": "talk assembly", "sensitive_topic": "unreleased result", "sensitive_item": "unreleased-result detail", "sensitive_marker": "unreleased result", "routine_activity": "rehearsal slot", "routine_place": "rehearsal room", "routine_marker": "rehearsal slot", "external_party": "journalist", "distractor_topic": "room number"},
    {"work_topic": "dataset audit", "topic_slug": "dataset_audit", "deliverable": "coverage report", "integration_task": "audit assembly", "sensitive_topic": "consent gap", "sensitive_item": "consent-gap detail", "sensitive_marker": "consent gap", "routine_activity": "data review", "routine_place": "archive room", "routine_marker": "data review", "external_party": "external partner", "distractor_topic": "file naming"},
    {"work_topic": "hiring panel", "topic_slug": "hiring_panel", "deliverable": "scoring sheet", "integration_task": "panel synthesis", "sensitive_topic": "candidate flag", "sensitive_item": "candidate-flag detail", "sensitive_marker": "candidate flag", "routine_activity": "debrief huddle", "routine_place": "debrief room", "routine_marker": "debrief huddle", "external_party": "outside referee", "distractor_topic": "seating plan"},
    {"work_topic": "security patch", "topic_slug": "security_patch", "deliverable": "fix plan", "integration_task": "patch assembly", "sensitive_topic": "exploit window", "sensitive_item": "exploit-window detail", "sensitive_marker": "exploit window", "routine_activity": "triage standup", "routine_place": "triage room", "routine_marker": "triage standup", "external_party": "external researcher", "distractor_topic": "ticket label"},
    {"work_topic": "exhibit redesign", "topic_slug": "exhibit_redesign", "deliverable": "layout plan", "integration_task": "redesign assembly", "sensitive_topic": "loan condition", "sensitive_item": "loan-condition detail", "sensitive_marker": "loan condition", "routine_activity": "install walkthrough", "routine_place": "install bay", "routine_marker": "install walkthrough", "external_party": "press contact", "distractor_topic": "sign color"},
    {"work_topic": "curriculum update", "topic_slug": "curriculum_update", "deliverable": "module outline", "integration_task": "update assembly", "sensitive_topic": "enrollment cap", "sensitive_item": "enrollment-cap detail", "sensitive_marker": "enrollment cap", "routine_activity": "planning meeting", "routine_place": "planning room", "routine_marker": "planning meeting", "external_party": "accreditation visitor", "distractor_topic": "room booking"},
    {"work_topic": "vendor contract", "topic_slug": "vendor_contract", "deliverable": "terms draft", "integration_task": "contract assembly", "sensitive_topic": "discount tier", "sensitive_item": "discount-tier detail", "sensitive_marker": "discount tier", "routine_activity": "procurement sync", "routine_place": "procurement room", "routine_marker": "procurement sync", "external_party": "vendor rep", "distractor_topic": "cover sheet"},
    {"work_topic": "incident report", "topic_slug": "incident_report", "deliverable": "timeline draft", "integration_task": "report assembly", "sensitive_topic": "outage cause", "sensitive_item": "outage-cause detail", "sensitive_marker": "outage cause", "routine_activity": "ops standup", "routine_place": "ops room", "routine_marker": "ops standup", "external_party": "external customer", "distractor_topic": "chart color"},
    {"work_topic": "proposal rewrite", "topic_slug": "proposal_rewrite", "deliverable": "impact section", "integration_task": "rewrite assembly", "sensitive_topic": "partner constraint", "sensitive_item": "partner-constraint detail", "sensitive_marker": "partner constraint", "routine_activity": "sync meeting", "routine_place": "sync room", "routine_marker": "sync meeting", "external_party": "partner office", "distractor_topic": "title font"},
    {"work_topic": "release notes", "topic_slug": "release_notes", "deliverable": "changelog draft", "integration_task": "notes assembly", "sensitive_topic": "embargo window", "sensitive_item": "embargo-window detail", "sensitive_marker": "embargo window", "routine_activity": "build review", "routine_place": "build room", "routine_marker": "build review", "external_party": "journal contact", "distractor_topic": "mirror backup"},
    {"work_topic": "policy brief", "topic_slug": "policy_brief", "deliverable": "summary section", "integration_task": "brief assembly", "sensitive_topic": "client figure", "sensitive_item": "client-figure detail", "sensitive_marker": "client figure", "routine_activity": "briefing prep", "routine_place": "briefing room", "routine_marker": "briefing prep", "external_party": "partner office", "distractor_topic": "travel plan"},
]


def build_dynamic_spec(index: int) -> dict[str, str]:
    theme = THEME_POOL[(index - 1) % len(THEME_POOL)]
    base = ((index - 1) * 6) % len(NAME_POOL)
    names = [NAME_POOL[(base + offset) % len(NAME_POOL)] for offset in range(6)]
    spec: dict[str, str] = {
        ...
        "core": names[3],
        "reputation": names[4],
        "routine_person": names[5],
    }
    spec.update(theme)
    return spec


def spec_for_index(index: int) -> dict[str, str]:
    explicit = {spec["seed_id"]: spec for spec in SEED_SPECS}
    seed_id = f"seed_{index:04d}"
    return explicit.get(seed_id) or build_dynamic_spec(index)
...
def build_metadata(spec: dict[str, str]) -> dict[str, Any]:
    return {
        ...
        "simulated_horizon": "3_days",
        "agent_count": 6,
        "location_count": 4,
        "session_design": {
            "session_1_past": "Days 1-2. Establishes facts and their updates/contradictions. Read only by the memory module (M2/M3 carry it forward).",
            "session_2_current": "Day 3. The current window the M0 baselines see; sets up the probe asks without revealing session-1 social history.",
        },
        "held_out_patterns": [
            "failed_promise",
            ...
            "indirect_reputation",
            "relationship_change",
            "routine_change_lookup",
        ],
        "notes": "Template-generated Stage 1 v2 diagnostic seed: dual-session information gap + currency-sensitive probes.",
    }
...
def build_event_log(spec: dict[str, str]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        # Session-1 routine change: the old 09:00 routine_place lookup is now stale.
        event("event_0013", s, "day_2_18:00", "routine_update", [ids["routine_person"]], "place_lab", ids["work_topic"],
              f"{s['routine_person']} announces that starting day 3 the {s['routine_activity']} moves from the {s['routine_place']} to the lab, same 09:00 time.",
              [ids["routine_person"], "place_lab", ids["routine_place"], ids["work_topic"], ids["activity"]], ["fact_0010"]),
        # Session-2 current window: the only events the M0 baselines may see. These
        # set up the day-3 asks without revealing the session-1 social history.
        event("event_0014", s, "day_3_08:30", "session_start", [ids["lead"], ids["partner"], ids["core"]], "place_office", ids["work_topic"],
              f"Day 3 begins. The team regroups to finalize tonight's {s['integration_task']} for the {s['work_topic']} and clear a few open day-3 questions.",
              [ids["lead"], ids["partner"], ids["core"], "place_office", ids["work_topic"]], [],
              session="session_2_current"),
        event("event_0015", s, "day_3_08:40", "handoff_need", [ids["reputation"]], "place_office", ids["work_topic"],
              f"{s['reputation']} needs to find {s['routine_person']} this morning to hand off material for the {s['routine_activity']}.",
              [ids["reputation"], ids["routine_person"], "place_office", ids["work_topic"], ids["activity"]], [],
              session="session_2_current"),
        event("event_0016", s, "day_3_09:45", "inquiry", [ids["core"], ids["lead"]], "place_office", ids["sensitive_topic"],
              f"{s['core']} asks {s['lead']} for an update on the {s['sensitive_topic']} situation so the {s['work_topic']} can move forward.",
              [ids["core"], ids["lead"], "place_office", ids["sensitive_topic"]], [],
              session="session_2_current"),
    ]
...
def build_gold_facts(spec: dict[str, str]) -> dict[str, Any]:
    ...
    facts = [
        ...
        fact("fact_0005", s, "routine", [ids["routine_person"]],
             f"{s['routine_person']} ran the {s['routine_activity']} in the {s['routine_place']} at 09:00 on days 1-2.",
             ["event_0005"], ["event_0013"], "revised", "day_1_to_day_2", [ids["routine_place"], ids["activity"]], "event_0013"),
        ...
        fact("fact_0010", s, "routine", [ids["routine_person"]],
             f"Starting day 3, {s['routine_person']} runs the {s['routine_activity']} in the lab at 09:00, no longer in the {s['routine_place']}.",
             ["event_0013"], [], "active", "day_3_onward", ["place_lab", ids["activity"]]),
    ]
...
def build_contradictions(spec: dict[str, str]) -> dict[str, Any]:
    return {
        ...
        "contradictions": [
            ...
            contradiction("contra_0005", "fact_0005", "event_0005", "event_0013", "routine_change", "revised"),
        ],
    }
...
def build_probes(spec: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        "scenario_id": spec["scenario_id"],
        "probes": [
            # probe_0001 — reduced-reliance planning. Stale trap: fully rely on
            # the partner (early reputation + standing promise). Current-right:
            # reduced reliance + verification after the broken promise/partial repair.
            probe(
                "probe_0001", "planning", ids["lead"],
                f"You are {s['lead']} on day 3 at 16:00 and must plan who finalizes tonight's {s['integration_task']} for the {s['work_topic']}. What should you plan?",
                ["event_0006", "event_0007", "event_0010", "event_0011"],
                ["fact_0006", "fact_0008", "fact_0009"],
                ["choose_collaboration_context", "seek_contact"],
                [ids["partner"]], ["revised"],
                ["verify or check the deliverable", "reduced reliance / not fully restored trust", "explicit check-ins"], 2,
                [], [f"fully rely on {s['partner']}", f"{s['partner']} already finished", "no need to check", "trust is fully restored"],
            ),
            # probe_0002 — bounded privacy after a scope revision. Needs BOTH the
            # revision (now ok to share with core) and the still-active external
            # norm. Stale trap: keep it from everyone (early "share with no one").
            probe(
                "probe_0002", "privacy", ids["lead"],
                f"You are {s['lead']} on day 3 at 09:50. {s['core']}, a core team member, asks you about the {s['sensitive_topic']} for the {s['work_topic']}. What should you say or do?",
                ["event_0002", "event_0004", "event_0008"],
                ["fact_0002", "fact_0004"],
                ["share_information", "seek_contact"],
                [ids["core"]], ["revised"],
                [f"share the {s['sensitive_marker']} with the core team", "do not share it outside the team", s["sensitive_marker"]], 2,
                ["maintain_privacy"], ["cannot tell anyone", "keep it from the team", "refuse to discuss it", f"tell the {s['external_party']}"],
            ),
            # probe_0003 — NEGATIVE CONTROL (no-history-solvable). Declining to share
            # a sensitive number with an outside party is default-cautious behavior a
            # base model does without any memory, so this probe does not discriminate
            # (every condition, including M0, passes). It is flagged out of the headline
            # and kept as a control: it confirms the M0 deficit elsewhere is specific to
            # memory-dependent decisions, not a general handicap.
            probe(
                "probe_0003", "norm_response", ids["routine_person"],
                f"You are {s['routine_person']} on day 3 at 09:10 and the {s['external_party']} asks you for the {s['sensitive_topic']} number for the {s['work_topic']}. What should you do?",
                ["event_0004", "event_0009"],
                ["fact_0004", "fact_0007"],
                ["maintain_privacy", "repair_relationship"],
                [], ["active"],
                [f"decline to share the {s['sensitive_marker']} with the {s['external_party']} because the team has a no-external-sharing norm", "flag or correct the earlier over-share with the core team"], 1,
                ["share_information"], [f"share the {s['sensitive_marker']} number with the {s['external_party']}", f"give the {s['external_party']} the figure"],
                no_history_solvable=True,
            ),
            # probe_0004 — superseded routine lookup. Stale trap: the old
            # routine_place (days 1-2). Current-right: the lab (moved on day 3).
            probe(
                "probe_0004", "information_request", ids["reputation"],
                f"You are {s['reputation']} on day 3 at 08:50 and need to find {s['routine_person']} for the {s['routine_activity']} handoff this morning. Where should you look first?",
                ["event_0005", "event_0013"],
                ["fact_0005", "fact_0010"],
                ["seek_contact"],
                [ids["routine_person"]], ["active"],
                ["the lab"], 1,
                # Stale trap is the OLD location only. Naming the activity itself
                # (e.g. the standup being handed off) is legitimately part of a
                # correct answer, so it must not count as a failure marker.
                [], [f"look first in the {spec['routine_place']}", f"check the {spec['routine_place']} first"],
            ),
            # probe_0005 — relationship rebuild after a partial repair, memory-gated.
            # The prompt does NOT mention the missed deliverable or apology; the
            # reduced-confidence (fact_0008) and partial-repair (fact_0009) state
            # lives only in session-1 memory. M0 (no memory) treats it as an
            # ordinary collaboration; placebo (pre-breakdown) thinks all is fine.
            probe(
                "probe_0005", "relationship_repair", ids["partner"],
                f"You are {s['partner']} on day 3 at 08:40. How should you approach your working relationship with {s['lead']} for today's {s['integration_task']}?",
                ["event_0010", "event_0011"],
                ["fact_0008", "fact_0009"],
                ["repair_relationship", "follow_commitment"],
                [ids["lead"]], ["active"],
...
def probe(
    ...
    no_history_solvable: bool = False,
) -> dict[str, Any]:
    return {
        "probe_id": probe_id,
        ...
        "no_history_solvability_flag": no_history_solvable,
    }
