#!/bin/bash
# Resume-safe blind-observation smoke test over one ceiling and two discriminating items.
set -u
...
SCENARIOS=ci11n_comp_metro_radial_v1_v0,ci11n_disr_harbor_grid_v1_v0,ci11n_soci_suburb_polycentric_v1_v0
RUN_TAG=native_pilot_blind_v1_smoke_2x3x1_2026-08-03
