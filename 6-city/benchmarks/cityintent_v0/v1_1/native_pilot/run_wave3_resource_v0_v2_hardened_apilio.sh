...
SCENARIOS=ci11w3_reso_suburb_polycentric_v1_v0,ci11w3_reso_metro_radial_v1_v2
...
run_model() {
  name="$1"
  config="$2"
  output="$RESULT_ROOT/native_wave3_resource_v0_v2_hardened_2x2x1_2026-08-06_${name}"
  resume_flag=
