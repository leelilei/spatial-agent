#!/bin/bash
# Resilient wrapper for the E3d cross-vendor sweep: re-invokes the repeated experiment
...
[ -n "${FHL_API_KEY:-}" ] || { echo "FHL_API_KEY MISSING"; exit 1; }

OUT=/Users/mac/Documents/6-Research/6-city/results/cityintent_v1_rc1/e3d_crossvendor_deepseek_2x6hardx3_2026-07-10
SUMMARY="$OUT/agent_repeated_summary.csv"
CFG="$(pwd)/configs/yunwu_deepseek_v4flash.json"
