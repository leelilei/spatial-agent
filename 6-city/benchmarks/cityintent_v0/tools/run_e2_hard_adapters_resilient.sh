...
OUT=/Users/mac/Documents/6-Research/6-city/results/cityintent_v1_rc1/external_frameworks_4x6hardx3_gpt54mini_2026-07-10
SUMMARY="$OUT/agent_repeated_summary.csv"
CFG="$(pwd)/configs/fhl_gpt54mini.json"
