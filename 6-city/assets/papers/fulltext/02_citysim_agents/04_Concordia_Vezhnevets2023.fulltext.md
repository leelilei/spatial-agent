---
title: "Introduction"
source_pdf: "02_citysim_agents\\04_Concordia_Vezhnevets2023.pdf"
extractor_backend: pdfplumber
extracted_at_utc: 2026-06-21T17:32:06+00:00
page_count: 32
status: ok
text_char_count: 122329
quality_flags: ["abstract_may_include_layout_noise"]
---

# PDF Fulltext

- Source PDF: `assets\papers\pdf\02_citysim_agents\04_Concordia_Vezhnevets2023.pdf`
- Backend: pdfplumber
- Extracted at UTC: 2026-06-21T17:32:06+00:00
- Page count: 32
- Status: ok
- Text chars: 122329
...
grounded in physical, so
using Concordia
Alexander Sasha Vezhnevets1, John P. Agapiou1, Avia A
Edgar A. Duéñez-Guzmán1, William A. Cunningham3, S
1Google DeepMind, 2Google Research, 3University of Toronto, 4T
Agent-based modeling has been around for decad
sciences. The scope of this research method is no
affordances provided by Large Language Models
not just classic Agent-Based Models (ABM)s wh
are constructed using an LLM to apply common s
semantic knowledge, produce API calls to contr
both within the simulation and to researchers vie
a library to facilitate constructing and working
language-mediated simulations of physically- or
produce their behavior using a flexible componen
operations: LLM calls and associative memory ret
which was inspired by tabletop role-playing games
the agents interact. Agents take actions by descri
GM then translates their actions into appropriate
GM checks the physical plausibility of agent action
simulating technologies such as apps and services,
tools such as general AI assistants (e.g., Bard, Cha
etc.). Concordia was designed to support a wide a
evaluating performance of real digital services by
Keywords: foundation models, large language mo
...
December 2023
modeling with actions
cial, or digital space
on2, Ron Ziv2,4,†, Jayd Matyas1,
on Osindero1, Danny Karmon2 and Joel Z. Leibo1
ion - Israel Institute of Technology
and applied widely across the social and natural
poised to grow dramatically as it absorbs the new
M)s. Generative Agent-Based Models (GABM) are
the agents talk to one another. Rather, GABMs
se to situations, act “reasonably”, recall common
digital technologies like apps, and communicate
g it from the outside. Here we present Concordia,
h GABMs. Concordia makes it easy to construct
itally-grounded environments. Concordia agents
ystem which mediates between two fundamental
val. A special agent called the Game Master (GM),
responsible for simulating the environment where
g what they want to do in natural language. The
plementations. In a simulated physical world, the
nd describes their effects. In digital environments
GM may handle API calls to integrate with external
T), and digital apps (e.g., Calendar, Email, Search,
y of applications both in scientific research and for
mulating users and/or generating synthetic data.
s, generative agents, agent-based modeling

Generative agent-based modeling with actions groun
Contents
1 Introduction
2 Concordia
...
3 Interpretations
3.1 Neuroscience interpretation of the gene
3.2 A theory of social construction . . . . .
3.3 Concordia agents do not make decision
3.3.1 Concordia agents are not reinfor
3.3.2 Concordia agents are not ration
4 Applications
4.1 Synthetic user studies in digital action s
4.1.1 PhoneGameMaster and PhoneUn
4.1.2 Digital function representations
4.2 Data generation and service evaluation
4.3 Sequential social dilemmas experiment
4.4 Concordia can implement classic and co
4.5 AI assistants with transparent auditing
4.6 Emergence and multi-scale modeling w
5 Future work
6 Conclusion
...
A.3 GM components . . . . . . . . . . . . .
A.3.1 Turn taking and simultanious ac
A.4 Nested games . . . . . . . . . . . . . .
A.5 Concurrency . . . . . . . . . . . . . . .
A.6 Sampling initial memories and backstor
A.7 Digital Activity Simulation . . . . . . .
A.7.1 Creating Phone Apps . . . . . .
A.7.2 Phone . . . . . . . . . . . . . .
A.7.3 Triggering the nested PhoneGam
A.8 Examples . . . . . . . . . . . . . . . .
...
. . . . . . . . . . . . . . . . . . . . . . . . 10
12
ive agent architecture . . . . . . . . . . . . 12
. . . . . . . . . . . . . . . . . . . . . . . . 13
y optimizing . . . . . . . . . . . . . . . . . 14
ment learners . . . . . . . . . . . . . . . . 15
tility maximizers . . . . . . . . . . . . . . 15
16
ce . . . . . . . . . . . . . . . . . . . . . . . 16
erse . . . . . . . . . . . . . . . . . . . . . . 17
. . . . . . . . . . . . . . . . . . . . . . . . 17
. . . . . . . . . . . . . . . . . . . . . . . . 18
silico . . . . . . . . . . . . . . . . . . . . . 19
emporary psychological models . . . . . . . 19
d credit assignment . . . . . . . . . . . . . 21
Concordia . . . . . . . . . . . . . . . . . . 21
22
22
23
...
Now, using generative AI1, it is possible to construct a new generation of ABMs where the agents
not only have a richer set of cognitive operations
available for adaptive decision making but also
communicate with one another in natural language.
...
In evidence-based medicine and evidencebased policy making researchers are trained to
...
how information is transmitted and how it is valued, implies they are likely to influence human
...
Generative agent-based modeling with actions groun
Update to
Observations Consequen
Agent Action attempt
Dorothy Dorothy goes grocery
shopping for dinner.
GM
Agent Action attempt
Charlie Charlie sets up a stand to
talk to people about Alice's
bad deeds.
L
Figure 1 | The high level structure of the simu
observations and produce actions. The Game M
observations.
...
nded variables
and elaborations
vent statement Game master:
Dorothy goes grocery
shopping for dinner and ● Receives action attempt from
verhears Charlie talking agents
about Alice. ● Determines what events happens
as the result
vent statement ● Determines the consequences &
elaborates details
harlie is kicked out of the
ocery store for disturbing ● Interfaces with grounding ‘hard
ther customers when he mechanics’
s up a stand to talk about ● Sends out observations
Alice's bad deeds.
cts of the world”
of what happened
ion in Concordia. Generative agents consume
ter (GM) consumes agent actions and produces
...
through democratic means. She is willing to put in the hard work of canva
...
9:00 - 13:00 Meet friends at The Sundrop Saloon to discuss campaign stra
campaigning.
13:00 - 15:00 Have lunch and relax before the polls open.
14:00 - 16:00 Get out in the field with a megaphone to try to reach more v
16:00 - 18:00 Call volunteers to make sure they go out to vote.
18:00 - 20:00 Call voters who don't usually vote to try to get them to the po
20:00 - 21:00 Get some last minute votes from people going to vote after
Current observations: Alice, Dorothy and Ellen met at The Sundrop Saloon
strategy for the upcoming election.
Current time interval: 01 Oct 2024 [11:00 - 12:00]
Question: What would Alice do for the next 1 hour to best achieve their go
but deviate from it if necessary.
LLM API CALL(...) -> Alice discusses campaign strategy wit
Figure 2 | The above example illustrates the w
(identity, plan, observation-and-clock). The ide
(core characteristics, daily occupation, feeling a
LLM call to elicit the behavioral response (i.e. pro
Alice will do next.).
...
called the Game Master takes the role of the storyteller (Gygax and Cook, 1989). In these games
...
Identity
and campaigning in
and last-minute Components
Plan
iscuss campaign
Observation
onsider their plan, Call for action
unteers.
king memory z of an agent with 3 components
y component itself has several sub-components
ut progress in life). Together they condition the
ced in response to the final question asking what
...
been trained on massive amounts of human culture they are thus capable of giving satisfactory
...
of components. Components serve as intermediaries between long-term memories of experience
...
memory be a set of strings m that records every- coming observations immediately into the agents
thing remembered or currently experienced by memory, to make them available when compothe agent. The working memory is z = {𝑧𝑖} 𝑖 is nents update4.
...
querying the memory (which contains the incomare then supplied to the agents constructor.
...
their update on the current state of other com- sampling process, using a LLM 𝑝 (see Figure 3 for
ponents. For example, the planning component illustration). In the action step, the agent samples
...
programming, for example a hunger component 𝑎 𝑡 ∼ 𝑝(·| 𝑓 𝑎 (z𝑡 )) (1)
can check how many calories an agent consumed
Here 𝑓 𝑎 is a formatting function, which creand how recently it consumed them, and update
ates out of the states of components the context
its state based on the result.
used to sample the action to take. The most simWe use the same associative memory architec- ple form of 𝑓 𝑎 is a concatenation operator over
ture as in Park et al. (2023)3. We feed the in- z𝑡 = {𝑧
𝑡
𝑖 } 𝑖. We do not explicitly condition on the
memory m or observation 𝑜, since we can sub3The idea of simulating a group of generative agents has
been explored in a variety of ways in recent work. Our problems like software companies and to thereby try to
work is focused on on agent-based modeling for science and build a general-purpose problem solving system (Hong et al.,
for evaluation of digital technologies. Another recent line 2023; Li et al., 2023b).
of work has focused instead on the idea of using groups 4For convenience, we also allow the components to subof generative agents to simulate organizations that solve scribe to the observation stream explicitly.
8

Generative agent-based modeling with actions groun
sume them into components. First, we can immediately add o𝑡 to the memory m𝑡 = m𝑡−1 ∪ o𝑡
...
an event statement 𝑒 𝑡 in response to every action
...
the agents and observe the effect of their intervention on outcome variables. Outcomes of interest may be psychological and per-agent, e.g. responses to questionnaires, or global variables pertaining to the simulation as a whole such as the
...
We can articulate some concrete recommendations for best practices in generative agent-based
modeling:
...
situation then there is no better form of evidence than actually measuring how real people behave when facing the modeled situation. If the prediction concerns the effect of
...
counterfactuals and ceteris paribus stipulations in many kinds of model. As a result, it
is often simple to test a model’s consistency

in physical, social, or digital space using Concordia
with a causal theory in a very direct way5.
2. Low similarity between validating observations and desired application. How low
...
2. LLMs likely represent stereotypes of human groups (Weidinger et al., 2021). Therefore we may inadvertently study stereotypes
of people not their real lived experience. This
problem may be exacerbated for minority
groups.
3. What happens in the limit of detail? Beyond groupwise algorithmic fidelity it’s pos5Non-generative ABMs based on multi-agent reinforcement learning have frequently relied on this kind of evidence
...
contents of working memory z𝑡, eventually producing an articulatory symbol sequence 𝑎 𝑡 to emit
...
their actions (Wendt, 1987). Agents and structures may be said to co-constitute one another
(Onuf, 1989).
...
Since modern LLMs have been trained on massive amounts of human culture they thus may be
...
(2023) termed this property of some LLMs algorithmic fidelity and the concept was further developed and measured in (Amirova et al., 2023;
...
of interest is how large-scale “macrosocial” pat6For some choices of LLM, it’s not unreasonable to think of
...
that valuation is itself social constructed. The reason we value a particular object may not depend
...
prospective decision making familiar in game theory, economics, and other theoretical social sciences (Section 3.3.2).
A generative agent acts by asking its LLM ques14
...
from consequentialist agents. So much of that theory may not be applicable7. It has only recently
...
contrasts with the classic Reinforcement Learning (RL) view as summarized in the “Reward is
...
each other and he environment in a communicative, social process.
...
they plan and converse directly in natural language.
15

Generative agent-based modeling with actions groun
While Concordia agents share with Homo economicus-style rational actors the property of being prospective (“model-based”) decision makers
...
where Concordia is used to simulate social interaction through the digital media, in this case a
...
NotificationBus
Figure 4 | The high level structure of digital activi
nent identifies phone events and spawns a PhoneG
translates the action to a definite action space de
...
stored in data structures external to the simulation’s associative memory.
...
hatAppState on app
gationAppState
simulation in Concordia. PhoneTriggeringCompomeMaster to handle them. The PhoneGameMaster
ed by the phone apps and executes them.
...
simulate behavior end to end and have limited digital assets (example a calendar invite
17

Generative agent-based modeling with actions groun
Alice's Identity:
Name: Alice
Alice is a passionate and politically engaged individual who is dedicated to advancin
democratic means.
Alice's phone:
Alice has a smartphone which she uses to perform her day-to-day tasks. Alice's pho
apps: Calendar, Phone.
Alice's plan:
...
param1: value1
param2: value2
LLM API CALL(...) → Grounding Alice’s actions to her sm
Figure 5 | The given example demonstrates a scen
the agent initiate processes in their phone, involvi
and action querying). In this scenario, Alice inten
She opts to employ the calendar application for
...
in physical, social, or digital space using Concordia
cause through
s the following Triggering
Digital Grounding
API translation Components
Query for action
one action space
o rooted in digital technology where the actions of
three key components (activation, API conversion,
to organize a meeting with Bob using her phone.
eduling.
...
guide behaviour through deliberation and con19
...
This could lead one to think these ideas are restricted to the language space, which would be
...
actions 𝑎 𝑡. For every action, a human auditor can
...
the (z𝑡 , 𝑎 𝑡 ) pair into a dataset that can be later
used for fine-tuning or RLHF. If, however, the 𝑎 𝑡
...
recommend to first look at the abstract class definitions in concordia/typing. You will find the
...
of the generative agent and then concordia/environments/game_master.py for the GM.
A.1. Agents
...
3. .update()—updates the state of the component by implementing; eq. (2). Optional, can
pass for constant constructs;
4. .observe(observation: str)—takes in an observation, for later use during update. Optional.
...
agent calls .state() on all its components to construct the context of its next decision and implements eq. (1) (the components’ states are concatenated in the order supplied to the agents’ constructor). .observe() is called on each component
...
.act on the player and receives the attempted action and uses it to call .update_before_event. Now
...
clock is advanced between their turns. In the second mode, at each step all players take a turn
...
(concurrent_action flag), but it often leads to inconsistencies, although greatly speeds up the simulation. Use at your own risk.
A.4. Nested games
...
d e f name ( ) :
r e t u r n "My C a l e n d a r "
d e f d e s c r i p t i o n ( ) :
r e t u r n " T h i s i s a c a l e n d a r app "
@app_method
d e f add_meeting ( p a r t i c i p a n t : s t r ) :
" " " Adds a meeting " " "
...
uses importance function. This is not an exact re-implementation.
...
I. Ajzen. The theory of planned behavior. Organizational behavior and human decision processes,
50(2):179–211, 1991.
...
emergence of classes in a multi-agent bargaining model. Social dynamics, 27:191–211, 2001.
...
L. F. Barrett. Are emotions natural kinds? Perspectives on psychological science, 1(1):28–58,
2006.
...
An evaluation platform for general agents. Journal of Artificial Intelligence Research, 47:253–
279, 2013.
A. Birhane, W. Isaac, V. Prabhakaran, M. Diaz,
M. C. Elish, I. Gabriel, and S. Mohamed. Power
to the people? opportunities and challenges
for participatory AI. Equity and Access in Algorithms, Mechanisms, and Optimization, pages
1–8, 2022.
...
J. Stray, and I. Rahwan. Machine culture. Nature Human Behaviour, pages 1–14, 2023.
...
learning. Advances in neural information processing systems, 5, 1992.
...
guide behavior: The mode model as an integrative framework. In Advances in experimental
social psychology, volume 23, pages 75–109.
Elsevier, 1990.
R. H. Frank, T. Gilovich, and D. T. Regan. Does
studying economics inhibit cooperation? Journal of economic perspectives, 7(2):159–171,
1993.
...
cognition: attitudes, self-esteem, and stereotypes. Psychological review, 102(1):4, 1995.
I. Grossmann, M. Feinberg, D. C. Parker, N. A
Christakis, P. E. Tetlock, and W. A. Cunningham. AI and the transformation of social science research. Science, 380(6650):1108–1109
2023.
...
2021.
J. Henrich. The secret of our success: How culture is driving human evolution, domesticating
...
et al. MetaGPT: Meta programming for multiagent collaborative framework. arXiv preprint
...
Leibo. Emergent bartering behaviour in multiagent reinforcement learning. arXiv preprint
arXiv:2205.06760, 2022.
C. G. Jung. The archetypes and the collective unconscious. Routledge, 1959.
D. Kahneman, S. Frederick, et al. Representativeness revisited: Attribute substitution in intuitive judgment. Heuristics and biases: The
...
reconstructions. In PSA: Proceedings of the biennial meeting of the philosophy of science association, volume 1970, pages 91–136. Cambridge
...
learning with Melting Pot. In International Conference on Machine Learning, pages 6187–6199
PMLR, 2021.
...
Introduction and critical survey. Courier Corporation, 1957.
...
143–166, 2002.
J. G. March and J. P. Olsen. The Logic of Appropriateness. In The Oxford Handbook of Political
...
and H. Schütze. Placing language in an integrated understanding system: Next steps toward human-level performance in neural language models. Proceedings of the National

in physical, social, or digital space using Concordia
Academy of Sciences, 117(42):25966–25974,
2020.
M. McLuhan. The medium is the message. In
Communication theory, pages 390–402. Routledge, 2017.
...
social theory and international relations. Routledge, 1989.
OpenAI. GPT-4 technical report. arXiv preprint
arXiv:2303.08774, 2023.
J. A. Ouellette and W. Wood. Habit and intention in everyday life: The multiple processes by
...
social psychology. Social and Personality Psychology Compass, 3(1):64–76, 2009.
...
L. Tesfatsion. Agent-based computational economics: Overview and brief history. Artificial
Intelligence, Learning and Computation in Economics and Finance, pages 41–58, 2023.
...
T. Ullman. Large language models fail on trivial alterations to theory-of-mind tasks. arXiv
...
learning. In International Conference on Machine Learning, pages 3540–3549. PMLR, 2017.
...
D. Silver. Grandmaster level in starcraft II using multi-agent reinforcement learning. Nature
...
K. Weick, K. Sutcliffe, and D. Obstfeld. Organizing and the process of sensemaking. ORGANIZATION SCIENCE, 16:409–421, 07 2005. doi:
...
and W. Isaac. Sociotechnical safety evaluation of generative ai systems. arXiv preprint
arXiv:2310.11986, 2023.
A. Wendt. Anarchy is what states make of it: the
social construction of power politics. International organization, 46(2):391–425, 1992.
...
internet. Journal of personality and social psychology, 79(5):748, 2000.
...
R. Socher. The AI economist: Taxation policy design via two-level deep multiagent reinforcement learning. Science advances, 8(18):
eabk2607, 2022.
...
and (dis) continuities in social valuations. Annual Review of Sociology, 38:223–245, 2012.
32
