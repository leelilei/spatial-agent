...
Source PDF: /Users/mac/Documents/6-Research/4-SpatialAgent-Survey/assets/survey_paper/pdfs/phase1_adjacent/12_TW-09_ELLMA-T_Social_VR_2024.pdf

Extraction:
- backend: pdfplumber
- extracted_at_utc: 2026-05-01T03:19:49+00:00
- page_count: 20
- status: ok
- text_char_count: 101293
...
- 2 Related Work (page 2)
  - 2.1 Supporting Situated Language Learning in VR (page 2)
  - 2.2 Embodied Conversational Agents for Language Learning (page 3)
  - 2.3 Potential of LLMs & LLM-agents for Language Learning in Social VR (page 3)
- 3 System Design (page 3)
  - 3.1 Design Principles (page 3)
  - 3.2 Learning English with ELLMA-T in VRChat (page 4)
  - 3.3 System Implementation (page 5)
- 4 User Study (page 6)
  - 4.1 Study Design (page 6)
  - 4.2 Participants and Setting (page 6)
  - 4.3 Procedure (page 8)
  - 4.4 Analysis (page 8)
- 5 Findings (page 8)
  - 5.1 Agent Perception and its Role in Social VR (page 8)
  - 5.2 Language Learning in Social VR (page 9)
  - 5.3 Task Design and Perceptions of LLM's Efficacy in Language Learning Tasks (page 10)
  - 5.4 Interest in Continued Usage (page 11)
- 6 Discussion (page 12)
  - 6.1 User Experience of ELLMA-T for Supporting English Language Learning (page 12)
  - 6.2 Situated Language Learning in Social VR (page 13)
  - 6.3 LLMs for Language Learning: Performance and Potential (page 13)
- 7 Design Implications (page 14)
  - 7.1 Promoting Personalized and Adaptive Learning through Design (page 14)
  - 7.2 Enhance Agent-Learner Connection (page 15)
  - 7.3 Cultivate Long-Term Engagement and Continued Use (page 15)
- 8 Limitations & Future Work (page 15)
- 9 Conclusion (page 16)
- References (page 16)
- A Appendix (page 19)
  - A.1 Single System Prompt (page 19)
  - A.2 Multi-task Prompt (page 19)
- B Interview Questions (page 20)
...
Preprint,September2024, MengxuPan,AlexandraKitson,HongyuWan,andMirjanaPrpa
...
Thecontributionswepresentinthispaperarethefollowing: withcomplexneedsandlow-achievingstudents[42].

ELLMA-T:anEmbodiedLLM-agentforSupportingEnglishLanguageLearninginSocialVR Preprint,September2024,
...
guagemodels(LLMs)providenewtechnologicalcapabilitiesfor fiteachlearner’suniqueneeds[20];
...
proficiency.Thelengthofthefreespeechvariesfrom30seconds ELLMA-Tposesclarifyingquestionstopromptfurtherdialogue
...
isgeneratedfromtheGPT4modelbycallingOpenAIAPI.Thetext
...
oftheconversation’sbroadercontext.Eachsubtaskisexecuted review]bypostingrecruitmentadsviacampuscommunication
...
mixedEnglishproficiencieswhoaimtoenhanceoralproficiency
...
transcriptswerecross-referencedwithvideorecordingsandnotes agentastheteacherandtheheadofaclassroom."Othersenvisioned
...
astheneedforconsistencybetweentheagent’svoiceandvisual talktoyouandlookingintoyoureyes,".
...
Englishwhenyoutrytoagreewithsomeone’sidea.It oftencharacterizetraditionallanguagelearning.Theagent’sability
...
forthesystem. adheredtoturn-takingbywaitingfortheusertofinishspeaking
...
tivelanguagetutor:human-likeinteraction,enhancedemotional to the ECA can further enhance this emotional connection (P7,
...
positioningthesystemasavaluabletoolforcontinuouslanguage oftensufferedfromcommunicationbreakdownsduetotechnical
...
languageimprovementinSection5.3.1,underscoringtheneedfor languagelearning.
...
time.However,thedeploymentofAI-agentsinsocialVRplatforms 1https://hello.vrchat.com/community-guidelines
...
municativeandAffectiveStrategiestoanEmbodiedConversationalAgentto
...
VRExergame.InProceedingsofthe2020CHIConferenceonHumanFactorsin Pham, Gerson Kroiz, Feileen Li, Hudson Tao, Ashay Srivastava, Hevander
...
Comput.Interact.5,EICS(2021),202:1–202:24. https://doi.org/10.1145/3459744
...
If the user doesn't know the meaning of a vocabulary, explain and practice pronunciation with them.
