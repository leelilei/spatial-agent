# HC02 - Generative Agents: Interactive Simulacra of Human Behavior
...
The Smallville town world is spatially explicit at the level of places, movement, and co-presence, but agent-facing input remains textual rather than geometric.

## Original Artifact Pointer

- local_artifact_path: `assets/survey_paper/pdfs/phase1_core/01_Generative_Agents_Park2023.pdf`

## Source Content

Title: Abstract

Source PDF: D:\0-AI相关研究\1-spatialagent\spatial-agent\assets\survey_paper\pdfs\phase1_core\01_Generative_Agents_Park2023.pdf

Extraction:
- backend: pypdf
- extracted_at_utc: 2026-04-28T16:32:14+00:00
- page_count: 22
- status: ok
- text_char_count: 130433
...
and Pharmacy
Rating: <fill in>
This prompt returns an integer value of2 for “cleaning up the room”
...
composition from 1:00 pm to 5:00 pmbecomes 1:00 pm: start
...
set of ranked outcomes, TrueSkill outputs a mean rating value𝜇 and
...
Prototypes for Social Computing Systems. InIn the 35th Annual ACM Symposium
...
Evaluation Procedure for Multi-Agent Story Generation Systems. InProceedings
of the 5th International Working Conference on Intelligent Virtual Agents (IV A’05).
...
Codemend: Assisting interactive programming with bimodal embedding. InPro-
...
• If you had to guess given what you know about [A yesha Khan],
...
• If you had to get something [A yesha Khan] likes for her birth-
